    ...
    const features = [
        {
            ...
            description: 'Dynamically generates configuration sections using Envoy proto files. Create Listeners, Clusters, Endpoints, and HTTPRoutes directly from the UI with TypeScript validation.',
            color: 'from-blue-500 to-cyan-500'
        },
        {
            Icon: GitBranch,
            title: 'Interactive Dependency Graphs',
            description: 'Visual flow diagrams display relationships between Envoy components. Understand resource dependencies, data flow, and troubleshoot configurations with ease.',
            color: 'from-green-500 to-emerald-500'
        },
        {
            Icon: Zap,
            title: 'Quick Start Scenarios',
            description: 'Effortlessly generate basic and advanced Envoy configurations with minimal input. Automated resource creation streamlines the configuration process.',
            color: 'from-yellow-500 to-orange-500'
        },
        {
            Icon: Camera,
            title: 'Snapshot Dump Visualization',
            description: 'Detailed view of current configuration snapshot. Inspect all resources associated with specific listeners for debugging and validation purposes.',
        ...
        },
        {
            ...
            description: 'Manage multiple Envoy versions from single interface. Dynamic routing based on bootstrap files enables centralized management of different version requirements.',
            ...
            <div className="container mx-auto">
                ...
                >
                    ...
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                        Combining React TypeScript frontend with Go backend, Elchi
                        provide a complete solution for enterprise Envoy management
                    </p>
                </motion.div>
