        ...
        <section id="architecture" className="py-24 px-6 relative">
            <div className="container mx-auto">
                ...
                >
                    ...
                    <div className="mb-8">
                        <h4 className="text-lg font-semibold text-purple-400 mb-4 text-center">Backend & Control Plane</h4>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="glass-effect p-4 rounded-lg text-center hover:scale-105 transition-transform duration-300">
                            ...
                            <div className="glass-effect p-4 rounded-lg text-center hover:scale-105 transition-transform duration-300">
                                ...
                                <div className="text-sm font-bold text-white">xDS Protocol</div>
                            ...
                            <div className="glass-effect p-4 rounded-lg text-center hover:scale-105 transition-transform duration-300">
                                ...
                                <div className="text-sm font-bold text-white">Protocol Buffers</div>
                                <div className="text-xs text-gray-400">Serialization</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div className="glass-effect p-4 rounded-lg text-center hover:scale-105 transition-transform duration-300">
                                ...
                                <div className="text-xs text-gray-400">Go-based Agent</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="glass-effect p-4 rounded-lg text-center hover:scale-105 transition-transform duration-300">
                                ...
                                <div className="text-sm font-bold text-white">Service Mesh</div>
                                <div className="text-xs text-gray-400">Traffic Management</div>
                            </div>
                        </div>
                    </div>
                </motion.div>
