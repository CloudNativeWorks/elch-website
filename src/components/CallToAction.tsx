                        ...
                        >
                            <div className="flex items-center justify-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-gray-400 text-sm">Demo Access</div>
                                </div>
                            </div>
                            <div className="flex items-center justify-center space-x-3">
                            ...
                            <div className="flex items-center justify-center space-x-3">
                                ...
                                <div>
                                    <div className="text-2xl font-bold text-white">xDS</div>
                                    <div className="text-gray-400 text-sm">Protocol Support</div>
                                </div>
                            </div>
                        </motion.div>
